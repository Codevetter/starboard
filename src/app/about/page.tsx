  ...
  return (
    <section>
      ...
      <p className="mt-3 text-muted-foreground">
        ...
        list, add repositories from the Starred menu, and search stars by repository name or topic.
        This keeps organization on GitHub and needs no additional account connection.
      </p>
      <p className="mt-3 text-muted-foreground">
  ...
  return (
    <section>
      ...
      <p className="mt-3 text-muted-foreground">
        ...
        description as vectors and retrieves similar meanings even when the words differ. Starboard
        combines SQLite FTS5 over names, descriptions, and topics with embedding retrieval, blends
        the ranks with reciprocal-rank fusion, and falls back to lexical results when the semantic
        service is unavailable.
      </p>
      <p className="mt-3 text-muted-foreground">
        Semantic similarity is not proof that a repository is good, maintained, secure, or right for
        your stack. It improves recall; source inspection, releases, maintenance evidence, and your
        judgment still determine whether to use a repository.
      </p>
    </section>
  );
}
  ...
  return (
    <section>
      ...
      <ol className="mt-3 list-decimal space-y-2 pl-5">
        <li>
          <strong>Sync read-only metadata.</strong> Starboard requests access to the public profile
          and starred repositories, not repository write scopes.
        </li>
        <li>
          <strong>Create a few durable collections.</strong> Organize outcomes such as
          &ldquo;evaluation tools&rdquo; or &ldquo;local inference,&rdquo; not every repository.
        </li>
        <li>
        ...
        <li>
          <strong>Search by intent.</strong> Try &ldquo;local eval framework for RAG&rdquo; instead
        ...
        <li>
          <strong>Keep the decision on GitHub.</strong> Inspect the source and license, then star or
          unstar through GitHub.
        </li>
      </ol>
    </section>
  );
...
function ComparisonAndLimitsSections() {
  return (
    <>
      <section>
        ...
        <p className="mt-3 text-muted-foreground">
          ...
          similar-project grounding, tool intelligence, and public discovery. This describes product
          surfaces; it is not a claim that one organizer is universally better.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mt-3 text-muted-foreground">
          ...
          metadata, connected projects, tags, lists, and notes still become application data. Review
          the privacy page and revoke access from GitHub settings whenever you stop using the
          service.
        </p>
      </section>
    </>
