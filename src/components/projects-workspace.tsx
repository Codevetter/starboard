      ...
      <div className="mx-auto grid max-w-7xl gap-6 px-4 py-6 md:grid-cols-[18rem_minmax(0,1fr)] md:px-6">
        <aside className="space-y-5">
          <section>
            ...
            <ConnectProjectForm initialRepository={initialRepository} onConnected={connected} />
          </section>
              ...
              <section>
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {recommendations && (
                        <Badge variant="outline">
                          {retrievalLabel(recommendations.retrieval.mode)}
                        </Badge>
                      )}
                    </div>
                    <p className="mt-1 text-sm text-muted-foreground">
                      The grounding set for recommendations, retrieved from the public catalog and
                      reranked by visible evidence.
                    </p>
                  </div>
                  <Button asChild variant="outline" size="sm">
                    <Link href="/discover" prefetch={false}>
                ...
                {recommendations?.fallback && (
                  <p className="mt-4 rounded-md border border-amber-500/30 bg-amber-500/10 p-3 text-sm text-amber-800 dark:text-amber-200">
                    This project has limited context, so these are broad catalog picks. No tool is
                    presented as a grounded recommendation in this state.
                  </p>
                )}
                {recommendationError && (
                ...
                <section>
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      ...
                      above, with support and source confidence visible.
                    </p>
                  </div>
