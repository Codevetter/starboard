...
export function analyzeRadarRepo(repo: RadarRepoInput, now = new Date()): RadarRepo {
...
export function buildRadarReport(repos: RadarRepoInput[], now = new Date()): RadarReport {
